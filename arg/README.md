...
func main() {
	...
	// If a command was dispatched, Parse handled it and returned nil.
	if opt.CommandRun != "" {
		return
	}
}
...
Note: Parse returns nil for empty argument lists. Use HelpOrFail or check `len(args) == 0` if you want to treat an empty invocation as a help case.
